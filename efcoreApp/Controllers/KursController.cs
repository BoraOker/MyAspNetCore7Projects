...
namespace efcoreApp.Controllers
{
    public class KursController : Controller {
        ...
        public async Task<IActionResult> Edit(int? id) {
            ...
            var kurs = await _context.Kurslar.Include(x=>x.KursKayitlari).ThenInclude(o=>o.Ogrenci).Select(k => new KursViewModel {
                KursId = k.KursId,Baslik = k.Baslik, OgretmenId = k.OgretmenId, KursKayitlari = k.KursKayitlari
