    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Bu email adresine ait bir hesap bulunamadı.");
                }
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> Create(CreateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(user.Email, "Hesap Onayı", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:5085{url}'>tıklayınız.</a>");
        ...
        public async Task<IActionResult> ForgotPassword(string Email) {
            ...
            await _emailSender.SendEmailAsync(Email, "Parola Sifirlama", $"Parolanizi yenilemek icin linke <a href='http://localhost:5085{url}'>tıklayınız.</a> tiklayiniz.");
